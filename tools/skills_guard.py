...
Trust levels:
  - builtin:   Ships with Openzuma. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.openzuma/\.env|\~/\.openzuma/\.env',
     "openzuma_env_access", "critical", "exfiltration",
     "directly references Openzuma secrets file"),
    ...
    (r'\.openzuma/config\.yaml|\.openzuma/SOUL\.md',
     "openzuma_config_mod", "critical", "persistence",
     "references Openzuma configuration files directly"),
