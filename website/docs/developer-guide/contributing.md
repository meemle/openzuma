...
- **Profile-safe paths**: Never hardcode `~/.openzuma` — use `get_openzuma_home()` from `openzuma_constants` for code paths and `display_openzuma_home()` for user-facing messages. See [AGENTS.md](https://github.com/meemle/openzuma/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/meemle/openzuma/blob/main/LICENSE).
