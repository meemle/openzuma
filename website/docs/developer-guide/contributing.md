...
sidebar_position: 4
title: "Contributing"
description: "How to contribute to Openzuma Agent — dev setup, code style, PR process"
---

# Contributing

Thank you for contributing to Openzuma Agent! This guide covers setting up your dev environment, understanding the codebase, and getting your PR merged.
...
echo 'OPENROUTER_API_KEY=sk-or-v1-your-key' >> ~/.openzuma/.env
```
...
- **Profile-safe paths**: Never hardcode `~/.openzuma` — use `get_openzuma_home()` from `openzuma_constants` for code paths and `display_openzuma_home()` for user-facing messages. See [AGENTS.md](https://github.com/NousResearch/openzuma-agent/blob/main/AGENTS.md#profiles-multi-instance-support) for full rules.

## Cross-Platform Compatibility

Openzuma officially supports Linux, macOS, and WSL2. Native Windows is **not supported**, but the codebase includes some defensive coding patterns to avoid hard crashes in edge cases. Key rules:
...
By contributing, you agree that your contributions will be licensed under the [MIT License](https://github.com/NousResearch/openzuma-agent/blob/main/LICENSE).
