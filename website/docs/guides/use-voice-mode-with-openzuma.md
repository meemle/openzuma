---
sidebar_position: 8
title: "Use Voice Mode with Openzuma"
description: "A practical guide to setting up and using Openzuma voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Openzuma
...
- you want Openzuma sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Openzuma.
...
## Step 1: make sure normal Openzuma works first
...
Openzuma supports both local and cloud speech stacks.
...
4. Openzuma transcribes and responds
...
- asking Openzuma to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Openzuma loop.

## Tuning CLI behavior

### Silence threshold

If Openzuma starts/stops too aggressively, tune:
...
Openzuma stays a normal chat bot, but can speak replies.
...
- you want Openzuma to function like a portable research or ops assistant
...
Openzuma joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Openzuma detects speech boundaries
- transcripts are posted in the associated text channel
- Openzuma responds in text and audio
...
1. get text Openzuma working
2. install `openzuma-agent[voice]`
