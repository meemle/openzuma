...
version: 1.1.0
author: Openzuma Agent (adapted from obra/superpowers)
license: MIT
metadata:
  openzuma:
...
> **For Openzuma:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Openzuma tools to understand the project:
