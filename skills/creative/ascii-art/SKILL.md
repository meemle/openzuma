...
```bash
python3 -m pyfiglet "OPENZUMA" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=OPENZUMA&font=Slant" | boxes -d stone
```
