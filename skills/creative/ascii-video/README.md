...
Built for [Openzuma Agent](https://github.com/NousResearch/openzuma-agent). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/openzuma-agent/skills/creative/ascii-video`](https://github.com/NousResearch/openzuma-agent/tree/main/skills/creative/ascii-video) via PR.
