...
Built for [Openzuma Agent](https://github.com/meemle/openzuma). Usable in any coding agent. Canonical source lives here; synced to [`meemle/openzuma/skills/creative/ascii-video`](https://github.com/meemle/openzuma/tree/main/skills/creative/ascii-video) via PR.
