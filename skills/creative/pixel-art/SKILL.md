...
```python
import sys
sys.path.insert(0, "/home/teknium/.openzuma/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.openzuma/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Openzuma installs package this)
