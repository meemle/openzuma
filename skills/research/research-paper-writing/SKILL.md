...
## Openzuma Agent Integration

This skill is designed for the Openzuma agent. It uses Openzuma tools, delegation, scheduling, and memory for the full research lifecycle.

### Related Skills

Compose this skill with other Openzuma skills for specific phases:
...
| **plan** | Phase 0 (Setup): creating structured plans before execution. Writes to `.openzuma/plans/` | `skill_view("plan")` |
