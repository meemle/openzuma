 ...
 *
 * Plugins call window.__OPENZUMA_PLUGINS__.register(name, Component)
...
declare global {
  interface Window {
    __OPENZUMA_PLUGIN_SDK__: unknown;
    __OPENZUMA_PLUGINS__: {
...
export function exposePluginSDK() {
  window.__OPENZUMA_PLUGINS__ = {
    register: registerPlugin,
  };

  window.__OPENZUMA_PLUGIN_SDK__ = {
