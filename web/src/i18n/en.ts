...
export const en: Translations = {
  ...
  status: {
    ...
    stopped: "Stopped",
    updateOpenzuma: "Update Openzuma",
    updatingOpenzuma: "Updating Openzuma…",
  ...
  skills: {
    ...
    all: "All",
    noSkills: "No skills found. Skills are loaded from ~/.openzuma/skills/",
  ...
  config: {
    configPath: "~/.openzuma/config.yaml",
