#!/usr/bin/env python3
"""
SWE Runner with Openzuma Trajectory Format

A runner that uses Openzuma-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Openzuma-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Openzuma-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Openzuma format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Openzuma-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Openzuma-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Openzuma Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Openzuma-Agent's built-in execution environments
    and outputs trajectories in Openzuma-Agent format.
    """
    ...
    def _convert_to_openzuma_format(
        self,
        ...
        """
        Convert internal message format to Openzuma trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Openzuma trajectory format
        trajectory = self._convert_to_openzuma_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Openzuma trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Openzuma Trajectory Format")
    print("=" * 60)
