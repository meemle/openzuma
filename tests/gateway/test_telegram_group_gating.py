...
def test_group_messages_can_require_direct_trigger_via_config():
    ...
    assert adapter._should_process_message(_group_message("hi @openzuma_bot", entities=[_mention_entity("hi @openzuma_bot")])) is True
    ...
    assert adapter._should_process_message(
        _group_message("/status@openzuma_bot", entities=[_mention_entity("/status@openzuma_bot")])
    ) is True
