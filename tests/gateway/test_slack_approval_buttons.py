...
class TestSlackExecApproval:
    ...
    async def test_sends_blocks_with_buttons(self):
        ...
        assert "openzuma_approve_once" in action_ids
        assert "openzuma_approve_session" in action_ids
        assert "openzuma_approve_always" in action_ids
        assert "openzuma_deny" in action_ids
...
class TestSlackApprovalAction:
    ...
    async def test_deny_action(self):
        ...
        action = {"action_id": "openzuma_deny", "value": "session-key"}
