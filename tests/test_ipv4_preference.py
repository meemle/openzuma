...
def _reload_constants():
    """Reload openzuma_constants to get a fresh apply_ipv4_preference."""
    import openzuma_constants
    importlib.reload(openzuma_constants)
    return openzuma_constants
...
class TestApplyIPv4Preference:
    ...
    def test_patches_getaddrinfo_when_forced(self):
        ...
        assert getattr(socket.getaddrinfo, "_openzuma_ipv4_patched", False) is True
