...
class TestHostHeaderValidator:
    ...
    def test_loopback_bind_accepts_loopback_names(self):
        from openzuma_cli.web_server import _is_accepted_host

        for bound in ("127.0.0.1", "localhost", "::1"):
            for host_header in (
                "127.0.0.1", "127.0.0.1:9219",
                "localhost", "localhost:9219",
                "[::1]", "[::1]:9219",
            ):
    ...
    def test_zero_zero_bind_accepts_anything(self):
        ...
        for host in ("10.0.0.5", "evil.example", "my-server.corp.net"):
            ...
            assert _is_accepted_host(host + ":9219", "0.0.0.0")
    ...
    def test_explicit_non_loopback_bind_requires_exact_match(self):
        ...
        assert _is_accepted_host("my-server.corp.net:9219", "my-server.corp.net")
    ...
    def test_case_insensitive_comparison(self):
        ...
        assert _is_accepted_host("LocalHost:9219", "127.0.0.1")
