"""Tests for openzuma_cli.auth._update_config_for_provider clearing stale fields.
...
from openzuma_cli.auth import _update_config_for_provider
from openzuma_cli.config import get_config_path
