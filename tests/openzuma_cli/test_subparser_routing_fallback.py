...
The main() function in openzuma_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `openzuma -c model`
...
def _build_parser():
    """Build a minimal replica of the openzuma top-level parser."""
