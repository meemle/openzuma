"""Tests for the interactive session browser (`openzuma sessions browse`).
...
from openzuma_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """openzuma sessions browse should be parseable."""
        from openzuma_cli.main import main as _main_entry
