...
def _enable_managed_nous_tools(monkeypatch):
    ...
    openzuma_cli.auth and openzuma_cli.models — so the function body returns True.
    """
    monkeypatch.setattr("openzuma_cli.auth.get_nous_auth_status", lambda: {"logged_in": True})
    monkeypatch.setattr("openzuma_cli.models.check_nous_free_tier", lambda: False)
