...
class TestWriteDenyExactPaths:
    ...
    def test_openzuma_env(self):
        path = os.path.join(str(Path.home()), ".openzuma", ".env")
        assert _is_write_denied(path) is True
...
class TestWriteAllowed:
    ...
    def test_openzuma_config_not_env(self):
        path = os.path.join(str(Path.home()), ".openzuma", "config.yaml")
