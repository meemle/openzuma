...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("openzuma_cli.config.get_config_path", return_value=config_path), \
             patch("openzuma_cli.config.ensure_openzuma_home"):
    ...
    def test_save_env_value_sets_0600(self):
        ...
        with patch("openzuma_cli.config.get_env_path", return_value=env_path), \
             patch("openzuma_cli.config.ensure_openzuma_home"):
    ...
    def test_ensure_openzuma_home_sets_0700(self):
        home = Path(self.tmpdir) / ".openzuma"
        with patch("openzuma_cli.config.get_openzuma_home", return_value=home):
