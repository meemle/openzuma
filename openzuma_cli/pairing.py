...
Usage:
    openzuma pairing list              # Show all pending + approved users
    openzuma pairing approve <platform> <code>  # Approve a pairing code
    openzuma pairing revoke <platform> <user_id> # Revoke user access
    openzuma pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle openzuma pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: openzuma pairing {list|approve|revoke|clear-pending}")
        print("Run 'openzuma pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print("  Run 'openzuma pairing list' to see pending codes.\n")
