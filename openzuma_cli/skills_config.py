"""
Skills configuration for Openzuma Agent.
`openzuma skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.openzuma/config.yaml under:
...
from openzuma_cli.platforms import PLATFORMS as _PLATFORMS
...
def skills_command(args=None):
    """Entry point for `openzuma skills`."""
    from openzuma_cli.curses_ui import curses_checklist
