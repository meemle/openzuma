# OpenZuma - Android应用项目

一个功能丰富的开源Android应用，可以在安卓手机上部署运行。
...
### 2. 修改API配置
在 `app/src/main/res/values/config.xml` 中添加：
```xml
...
- 邮箱：[你的邮箱]
- Gitee: [你的Gitee主页]
- 项目主页：https://gitee.com/your-username/openzuma
