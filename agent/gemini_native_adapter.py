...
Openzuma keeps ``api_mode='chat_completions'`` for the ``gemini`` provider so the
...
Why this exists
---------------
Google's OpenAI-compatible endpoint has been brittle for Openzuma's multi-turn
...
class GeminiAPIError(Exception):
    """Error shape compatible with Openzuma retry/error classification."""
...
class GeminiNativeClient:
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": "openzuma-agent (gemini-native)",
        }
