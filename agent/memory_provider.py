...
class MemoryProvider(ABC):
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        kwargs always include:
          - openzuma_home (str): The active OPENZUMA_HOME directory path. Use this
            for profile-scoped storage instead of hardcoding ``~/.openzuma``.
        ...
        kwargs may also include:
          ...
          - agent_workspace (str): Shared workspace name (e.g. "openzuma").
    ...
    def get_config_schema(self) -> List[Dict[str, Any]]:
        ...
        Used by 'openzuma memory setup' to walk the user through configuration.
    ...
    def save_config(self, values: Dict[str, Any], openzuma_home: str) -> None:
        """Write non-secret config to the provider's native location.

        Called by 'openzuma memory setup' after collecting user inputs.
        ``values`` contains only non-secret fields (secrets go to .env).
        ``openzuma_home`` is the active OPENZUMA_HOME directory path.
