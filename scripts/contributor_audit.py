...
IGNORED_PATTERNS = [
    ...
    re.compile(r"^Openzuma\s+(Agent|Audit)$", re.IGNORECASE),
...
IGNORED_EMAILS = {
    ...
    "openzuma@nousresearch.com",
    "openzuma-audit@example.com",
    "openzuma@habibilabs.dev",
}
...
def gh_pr_list():
    ...
    try:
        result = subprocess.run(
            [
                "gh", "pr", "list",
                "--repo", "NousResearch/openzuma-agent",
                "--state", "merged",
