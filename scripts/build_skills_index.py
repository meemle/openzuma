#!/usr/bin/env python3
"""Build the Openzuma Skills Index — a centralized JSON catalog of all skills.
...
`openzuma skills search/install` can use it without hitting the GitHub API.
...
# Ensure OPENZUMA_HOME is set (needed by tools/skills_hub.py imports)
os.environ.setdefault("OPENZUMA_HOME", os.path.join(os.path.expanduser("~"), ".openzuma"))
...
def main():
    print("Building Openzuma Skills Index...", flush=True)
