...
# Configuration
REPO_URL_SSH="git@github.com:meemle/openzuma.git"
REPO_URL_HTTPS="https://github.com/meemle/openzuma.git"
...
detect_os() {
    case "$(uname -s)" in
        ...
        CYGWIN*|MINGW*|MSYS*)
            ...
            log_info "  irm https://raw.githubusercontent.com/meemle/openzuma/main/scripts/install.ps1 | iex"
            exit 1
            ;;
        *)
            OS="unknown"
