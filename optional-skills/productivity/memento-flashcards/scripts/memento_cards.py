...
Data file: $OPENZUMA_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_OPENZUMA_HOME = Path(os.environ.get("OPENZUMA_HOME", Path.home() / ".openzuma"))
DATA_DIR = _OPENZUMA_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
