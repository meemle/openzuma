...
4. Name the token (e.g., "Openzuma Agent"), set an optional expiry, and click **Generate Token**
5. Copy the token and add to `~/.openzuma/.env`:
...
```bash
CANVAS="python $OPENZUMA_HOME/skills/productivity/canvas/scripts/canvas_api.py"
