...
Config: ~/.openzuma/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.openzuma/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_openzuma_home()`` helper (OPENZUMA_HOME-aware and
...
RULES_FILE = get_openzuma_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_openzuma_home() / "feishu_comment_pairing.json"
