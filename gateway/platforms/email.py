"""
Email platform adapter for the Openzuma gateway.

Allows users to interact with Openzuma by sending emails.
...
class EmailAdapter(BasePlatformAdapter):
    ...
    def _send_email(
        ...
        subject = ctx.get("subject", "Openzuma Agent")
        ...
        msg_id = f"<openzuma-{uuid.uuid4().hex[:12]}@{self._address.split('@')[1]}>"
