...
# Uses get_openzuma_home() so each profile gets its own Matrix store.
from openzuma_constants import get_openzuma_dir as _get_openzuma_dir

_STORE_DIR = _get_openzuma_dir("platforms/matrix/store", "matrix/store")
...
class MatrixAdapter(BasePlatformAdapter):
    ...
    def __init__(self, config: PlatformConfig):
        ...
        self._text_batch_delay_seconds = float(
            os.getenv("OPENZUMA_MATRIX_TEXT_BATCH_DELAY_SECONDS", "0.6")
        )
        self._text_batch_split_delay_seconds = float(
            os.getenv("OPENZUMA_MATRIX_TEXT_BATCH_SPLIT_DELAY_SECONDS", "2.0")
        )
    ...
    async def connect(self) -> bool:
        ...
        if self._encryption:
            ...
            try:
                ...
                _acct_id = self._user_id or "openzuma"
    ...
    def _strip_mention(self, body: str) -> str:
        ...
        mangle file paths like ``/home/openzuma/media/file.png``.
        """
        if self._user_id:
