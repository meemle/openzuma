...
def register_parser(name: str):
    ...
    Usage:
        @register_parser("openzuma")
        class OpenzumaToolCallParser(ToolCallParser):
            ...
    """
...
def get_parser(name: str) -> ToolCallParser:
    ...
    Args:
        name: Parser name (e.g., "openzuma", "mistral", "llama3_json")
...
from environments.tool_call_parsers.openzuma_parser import OpenzumaToolCallParser  # noqa: E402, F401
