"""
Monkey patches for making openzuma-agent tools work inside async frameworks (Atropos).
...
Usage:
    Call apply_patches() once at import time (done automatically by openzuma_base_env.py).
